...
function OrderTOForm({id, name}) {
    ...
    return (
        ...
        <form onSubmit={submit}>
            ...
            <InputLabel htmlFor="date" value="Дата начала работ" />
            <TextInput
                id="date"
                name="date"
                type="date"
            ...
            <InputLabel htmlFor="date" value="Дата окончания работ" />
            <TextInput
                id="date"
                name="date"
                type="date"
    ...
    <td/>
    <PrimaryButton className="ms-4" disabled={processing}>Добавить наряд ТО</PrimaryButton>
  </form>
        </GuestLayout>
     );
}

export default OrderTOForm;
